	...
	$(document)
			.ready(
					function() {
										...
										function() {
											if ($("#petsitterboardregForm :input:radio[name=service]:checked").length == 0) {
												...
												return false;
													...
													"#petsitterboardregForm :input[name=petsitterboard_title]")
													.val() == "") {
												alert("제목을 입력하세요.");
												return false;
											} else if ($(
													"#petsitterboardregForm #ta")
													.val() == "") {
												alert("내용을 입력하세요.");
												return false;
											}
						...
						$(
								"input:radio[name=service][value="
										+ "<c:out value='${petsitterVO.service}'/>"
										+ "]").attr("checked", "checked");
						$(
								"input:radio[name=petSize][value="
										+ "<c:out value='${petsitterVO.petSize}'/>"
										+ "]").attr("checked", "checked");
						$(
								"input:radio[name=petType][value="
										+ "<c:out value='${petsitterVO.petType}'/>"
										+ "]").attr("checked", "checked");
				...
				<div class="SBHrAllLine">
					<table class="SBtable">
						...
						<tr>
							...
							<td style="vertical-align: middle; width: 40%"><input
								type="text" class="datepicker" id="sdate" name="startDay"
								style="width: 80%;"></td>
							<th style="vertical-align: middle; width: 10%">EndDay</th>
							<td style="vertical-align: middle; width: 40%"><input
								type="text" class="datepicker" id="edate" name="endDay"
								style="width: 80%;"></td>
						</tr>
						<tr>
								...
								<table style="width: 100%;">
									<tr>
										<td style="width: 20%;"><input type="radio"
											name="petSize" value="laarge" />커다란 pet</td>
										<td style="width: 10%;"><input type="radio"
											name="petSize" value="middle" />보통 pet</td>
										<td style="width: 20%;"><input type="radio"
											name="petSize" value="small" />아가 pet</td>
									</tr>
								</table>
							</td>
