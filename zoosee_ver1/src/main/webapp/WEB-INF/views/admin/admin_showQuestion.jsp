...
<div class="SBcontainer_main">
   <div class="SBcontainer_innerMain">
      <div style="margin-bottom: 3%; text-align: center;">
         <label style="font-size: 18px;"> 1:1 질문 답변확인 및 수정  </label>
      </div>
      <form>
         <table class="SBtable">
            <tr>
            ...
            <tr>
               <th colspan="4"><textarea class="SBform-textarea"
                     style="height: 200px" readonly="readonly">${qnaBoardVO.question}</textarea></th>
            </tr>
            <c:choose>
