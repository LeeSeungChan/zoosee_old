...
<div class="BJMainDIVBottom"   align="center">
   <div class="BJMainBoardDiv" >
      <div class="BJMainBoardC1">
          <a href="${initParam.root}interceptor_petsitter_register.do"><img  src="${initParam.root }resources/image/ex1.JPG" style="width: 100%; height:100%; max-width: 760px; vertical-align: middle" /></a>
      </div>
      <div class="BJMainBoardC2">
          <a href="${initParam.root}interceptor_qna_list.do"><img  src="${initParam.root }resources/image/ex2.JPG" style="width: 100%; height:100%; max-width: 760px; vertical-align: middle" /></a>
      </div>
      <div class="BJMainBoardC3">
          <a href="${initParam.root}interceptor_freeBoard_list.do"><img  src="${initParam.root }resources/image/ex3.JPG" style="width: 100%; height:100%; max-width: 760px; vertical-align: middle" /></a>
      </div>
